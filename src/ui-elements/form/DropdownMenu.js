...
class DropdownMenu extends React.Component {
  ...
  render() {
    const rootStyling = 'ajc-flex-column ajc-flex-justify-left ajc-background-transparent ajc-width-dialog-inner ajc-spacing-bottom-small ajc-text-black ajc-font-default';
    ...
    return (
      <div className={rootStyling}>
        ...
        <select id={`${this.props.id}-dropdown-menu`} name={`${this.props.id}-dropdown-menu`} className={selectStyling} defaultValue={this.props.optionsList[0].value}>
          {
